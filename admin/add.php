                    ...
                    <div class="booking-form-container">
                        <form action="spot.php" method="POST">
                            ...
                            <select name="date" required>
                                ...
                                <option value="12-3">Novermber 10,2023</option>
                        <option value="13-3">Novermber 11,2023</option>
                        <option value="14-3">Novermber 12,2023</option>
                        <option value="15-3">Novermber 13,2023</option>
                        <option value="16-3">Novermber 14,2023</option>
                            </select>
