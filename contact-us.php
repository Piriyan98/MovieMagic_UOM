...
<body>
    ...
    <div class="contact-us-container">
        ...
        <div class="contact-us-section contact-us-section2">
            <h1>Address & Info</h1>
            <h3>Phone Numbers</h3>
            <p><a href="tel:0123456789">+94 123456789</a><br>
                <a href="tel:01011391148">+94 123456789</a></p>
            <h3>Address</h3>
            <p>Katubedda junction,  Moratuwa</p>
            <h3>E-mail</h3>
            <p><a href="nithilan32@gmail.com">nithilan32@gmail.com</a></p>
        </div>
    </div>
    <div style="width: 75%; height: 350px; margin: 15%;">
        <div class="gmap_canvas"><iframe id="gmap_canvas" src="https://maps.google.com/maps?4vNvGGPSjoE33Z8c6=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
        </div>
    </div>
    <footer></footer>
